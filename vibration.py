...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Estimate vibration frequency from a video file')
    parser.add_argument('video', metavar='VIDEO_PATH', type=str, help='path to input video file')
    args = parser.parse_args()

    # Call the main function
    estimate_vibration_frequency(args.video)
